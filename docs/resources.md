...
| Generating an API token | https://docs.pawapay.io/dashboard/other/system_conf/api_tokens |
| Production dashboard (don't use during the hackathon) | https://dashboard.pawapay.io |
...
| Resource | Link |
| --- | --- |
| WooCommerce checkout blocks | https://woocommerce.com/document/cart-checkout-blocks-status/ |
| Adding a payment gateway (concepts) | https://woocommerce.com/document/payment-gateway-api/ |
| Local WP dev environment | https://localwp.com/ |
